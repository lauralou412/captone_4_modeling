...
while (i<21) {
  var_name<-names(dir_imp[i])
  partialPlot(rf_rose,data_balanced_under, names(dir_imp[i]),main=var_name)
    i=i+1
    }

#plot lift chart
plotLift(pred.rf.under, test_balanced_under$HCV_STATUS, cumulative = TRUE, n.buckets = 100)
