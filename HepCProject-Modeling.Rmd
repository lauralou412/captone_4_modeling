...
#patients <- read_delim("Z:/Flat File/patients_HEDIS_20170816file.csv", ",", escape_double = FALSE, trim_ws = TRUE)
...
str(patients[,172:200])
str(patients[,201:460])

patients$PATIENT_ID <-  as.character(patients$PATIENT_ID)
patients$HCV_STATUS <-  as.numeric(patients$HCV_STATUS)
patients[8:127] <- sapply(patients[8:127], as.numeric)
